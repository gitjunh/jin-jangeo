import{p as i,i as h,f as _}from"./assets-DZw7ZkS0.js";async function u(e){const t=i(e),a=await fetch(`${t}?t=${Date.now()}`,{cache:"no-store"});if(!a.ok)throw new Error(`데이터를 불러올 수 없습니다: ${e}`);return a.json()}function v(e,t,a){const n=document.createElement("section");n.className="hero",n.id="top";const l=h()?'<span class="hero__badge hero__badge--closed">오늘 휴무</span>':'<span class="hero__badge hero__badge--open">영업 중</span>';n.innerHTML=`
  ...
  `,t}const m="jin_bgm_enabled";function M(){const e=new Audio(i("media/bgm.mp3"));e.loop=!0,e.volume=.18,e.preload="none";const t=document.createElement("button");t.type="button",t.className="bgm-btn",t.setAttribute("aria-label","배경음악"),t.textContent="♪";const a=n=>{t.classList.toggle("bgm-btn--on",n),t.title=n?"음악 끄기":"잔잔한 음악 켜기"};if(a(localStorage.getItem(m)==="1"),t.addEventListener("click",()=>{e.paused?e.play().then(()=>{localStorage.setItem(m,"1"),a(!0)}).catch(()=>{}):(e.pause(),localStorage.removeItem(m),a(!1))}),localStorage.getItem(m)==="1"){const n=()=>{e.play().then(()=>a(!0)).catch(()=>{}),document.removeEventListener("pointerdown",n)};document.addEventListener("pointerdown",n,{once:!0})}document.body.append(t)}async function T(e){e.innerHTML='<p class="loading">불러오는 중…</p>';try{const[t,a,n,c]=await Promise.all([u("/data/restaurant.json"),u("/data/menu.json"),u("/data/gallery.json"),u("/data/videos.json")]),l=y(t),{el:s,open:o}=x();e.innerHTML="";const d=document.createElement("main");d.className="page",d.append(v(t,c.hero,n.heroPoster),L(n.signature),E(a,o),S(n.grid,o),H(t)),e.append(d,f(t,()=>$(l)),l,s),M()}catch(t){e.innerHTML=`<p class="loading" style="color:#e94560">${t instanceof Error?t.message:"페이지를 불러올 수 없습니다."}</p>`}}const b=document.getElementById("app");if(!b)throw new Error("#app not found");T(b);
